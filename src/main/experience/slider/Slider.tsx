...
import ulbi from "../../../common/images/experience/avatar.png";
...
const SliderComponent = () => {
  ...
  return (
    <Carousel {...settings}>
      ...
      <div className={styles.slide}>
        <div
          className={styles.img + " " + styles.courses}
          style={{
            backgroundImage: `url(${udemy}), url(${from0}), url(${inc}), url(${ulbi})`,
          }}
        ></div>
        <div className={styles.text + " " + styles.textCourses}>
          ...
          <ul className={styles.list} style={{listStyle: `url(${icon})`}}>
            <li className={styles.item}>
              {langActive === "rus"
                ? "Продвинутый фронтенд (Ulbi TV)"
                : "Advanced frontend (Ulbi TV)"}
            </li>
            <li className={styles.item}>
              {langActive === "rus"
